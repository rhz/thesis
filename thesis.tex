...
% \newcommand{\M}{P} % discrete-time probability matrix
% \newcommand{\Mrev}{P_\pi} % reversible probability matrix
...
\abstract{
  ...
  describe their long-term probability distribution $\pi$.
  % 
  ...
  defines a continuous-time Markov chain of which $\pi$ is
...
\begin{acknowledgements}
  ...
  for their life-changing inventions.
