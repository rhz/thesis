...
is a description based on an \emph{energy function}.
...
Another, perhaps simpler way to construct this CTMC is
by first defining a \emph{labelled transition system}.
