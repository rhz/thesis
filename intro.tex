...
% How many a given molecule will be able to bind depends on
How many will depend on multiple factors like
the size of the two interacting molecules and
the region where they come in contact.
% Kappa calls these regions interaction sites or simply sites.
...
% The formal presentation of the language that we use here follows
% the category-theoretical approach proposed in \citet{kappadpo}.
% We follow the category-theoretical approach
% presented in \citet{kappadpo}.
The formal presentation that follows uses
