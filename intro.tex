...
It tell us which sites \emph{can} bind which sites,
not the ones they are bound to at a given moment. % particular time.
...
\footnote{We use the word graph, a synonym of network,
  in the formal presentation.}

\begin{definition}[site graph]
  A \emph{site graph} $G$ consists of
  finite sets of agents and sites, $\agents_G$ and $\sites_G$,
