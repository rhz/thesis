...
We call the homomorphism $h: G \to C$ a \emph{contact map} over $C$
...
\begin{center}
  ...
  \begin{tikzpicture}[grphdiag,baseline=-2.5,thick]
    ...
    \begin{scope}
      ...
      \site{lx}{x.west};
      \site{rx}{x.east};
      \node at (206:.5) {\scriptsize $l_x$};
      \node at (26:.5) {\scriptsize $r_x$};
    \end{scope}
    \begin{scope}[shift={(1.3,0)}]
      \nn[n5]{y}{0,0}{$y$};
      \site{ly}{y.west};
      \site{ry}{y.east};
      \node at (206:.5) {\scriptsize $l_y$};
      \node at (26:.5) {\scriptsize $r_y$};
    \end{scope}
    \begin{scope}[shift={(2.6,0)}]
      \nn[n5]{z}{0,0}{$z$};
      \site{lz}{z.west};
      \site{rz}{z.east};
      \node at (206:.5) {\scriptsize $l_z$};
      \node at (26:.5) {\scriptsize $r_z$};
    \end{scope}
  \end{tikzpicture}
\end{center}
\begin{alignat*}{3}
