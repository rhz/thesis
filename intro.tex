...
a rule and its inverse so to choose concrete rates we
impose a linear model which is explained in \sct{kinetic-model}.
...
We will show a similar language in \chp{inverse}
