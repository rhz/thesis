...
we show that it has (the discrete-time analogue of)
...
Given that the Markov chain is irreducible,
it will converge to $\ip$ as $t \to \infty$.
...
(think of a chain that can always attach new links).
