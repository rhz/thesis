...
\begin{definition}%[Infinitesimal generator]
  A (stable and conservative) \emph{infinitesimal generator} $\qm$
...
there exists a unique minimal solution to \eqn{transition-function}
\citep{anderson}.
% TODO: explain minimal
% Properties of transition functions and infinitesimal generators:
...
% TODO: this needs a citation... McQuarrie
\begin{equation}
  \label{eq:energy}
...
and is now common practice. % TODO: cite McQuarrie?
...
is not exempt of criticism ... % cite Addy Pross
